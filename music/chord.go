...
func Chord(note string, quality string, bass ...string) []uint8 {
	...
	chordIntervals := map[string][]uint8{
		...
		// Power chord (two-note chord, no 3rd)
		"5": {0, 7}, // root, P5
		...
		"mM7": {0, 3, 7, 11}, // Minor major 7th (m3, P5, M7)
